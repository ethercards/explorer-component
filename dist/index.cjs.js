...
const ExplorerCard = _ref => {
  ...
  const Card = () => {
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      }, trait.name)) : /*#__PURE__*/React__default["default"].createElement(GetTraitImage, {
...
const ExplorerComponent = _ref => {
  ...
  React.useEffect(() => {
    const getTraitTypes = async () => {
      await axios__default["default"].get(serverUrl + '/trait_types').then(resp => setTraitTypes(resp.data));
    };
    getTraitTypes();
  }, []);
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, nftList ? /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, nftList.length > 0 ? /*#__PURE__*/React__default["default"].createElement(ExplorerCards, {
    nftList: nftList,
    traitTypes: traitTypes,
