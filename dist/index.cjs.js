...
const ExpContext = /*#__PURE__*/React.createContext(null);
...
const ExplorerCard = _ref => {
  ...
  React.useEffect(() => {
    const fetchMetadata = async () => {
      setLoading(true);
      try {
        const response = await axios__default["default"].get(meta.tokenURI);
  ...
  const Card = () => {
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      if (trait.icon_url) {
        ...
        return /*#__PURE__*/React__default["default"].createElement(GetTraitImage, {
    ...
    }, /*#__PURE__*/React__default["default"].createElement("div", null, metadata.traits.length)))))), /*#__PURE__*/React__default["default"].createElement("div", {
...
const ExplorerCards = _ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(InfiniteScroll__default["default"], {
...
const ExplorerComponent = /*#__PURE__*/React.forwardRef((props, ref) => {
  const {
    tokenAddres,
    poolAddress,
    chainId,
  ...
  React.useEffect(() => {
    const getTraitTypes = async () => {
      try {
        const response = await axios__default["default"].get(serverUrl + '/trait_types');
  ...
  }, /*#__PURE__*/React__default["default"].createElement(ExpContext.Provider, {
    value: props
  }, nftList ? nftList.length > 0 ? /*#__PURE__*/React__default["default"].createElement(ExplorerCards, {
    nftList: nftList,
    traitTypes: traitTypes,
  ...
  }) : /*#__PURE__*/React__default["default"].createElement("p", null, error))));
});
