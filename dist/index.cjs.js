...
var galaxisUpgradedCard = require('galaxis-upgraded-card');
...
const ExplorerCard = _ref => {
  ...
  const Card = () => {
    ...
    }, /*#__PURE__*/React__default["default"].createElement(galaxisUpgradedCard.GalaxisCard, {
      name: "Teszt",
      metadata: metadata,
...
var ExplorerCards = function ExplorerCards(_ref) {
  ...
  var _useContext = React.useContext(ExpContext),
